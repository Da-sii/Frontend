        ...
        {accounts.map((account, idx) => (
          ...
          >
            <View className='flex-row justify-between'>
              <Text className='text-c1 font-n-bd text-gray-500'>가입 계정</Text>
              <Text className='text-c1 font-n-bd text-gray-700'>
                {account.email}
              </Text>
            </View>
            <View className='flex-row justify-between'>
              <Text className='text-c1 font-n-bd text-gray-500'>가입 경로</Text>
              <Text className='text-c1 font-n-bd text-gray-700'>
                {account.login_type}
              </Text>
            </View>
            <View className='flex-row justify-between'>
              <Text className='text-c1 font-n-bd text-gray-500'>가입일</Text>
              <Text className='text-c1 font-n-bd text-gray-700'>
